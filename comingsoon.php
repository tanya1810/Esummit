...
<div class="single-welcome-slide bg-img bg-overlay jarallax" >
   <img src="img/bg-img/1.jpg" alt="" style="width:100%; height: 100%;">
<div class="container h-100">
<div class="row h-100 align-items-center">


<div class="welcome-text text-right" style="position: absolute;right: 20px;top: 100px;">
<h3 data-animation="fadeInUp" data-delay="300ms">Big things and opportunities<br>come once in a while.<br><br>All the future Zuckerberg's gear up<br> for the biggest entrepreneurial event <br>of the year.</h3>
<h6 data-animation="fadeInUp" data-delay="500ms"> Click on the button below to receive regular<br>information and not miss any opportunity</h6>

<div class="input-group" style="position: absolute;right: 0px;top: 400px;width: 300px; height: 40px;">
  <input type="text" name="email" value="" required="required" placeholder="Email"/>
  <label for="text-1542372332072">Email</label>
  <div class="req-mark">!</div>
</div>
...
<br>
<div class="hero-btn-group" data-animation="fadeInUp" data-delay="700ms" style="position:absolute;right: 165px;top:470px;right: 20px;">
...
<div class="single-contact-info wow fadeInUp" data-wow-delay="300ms">
<p>Email:</p>
<h6><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="89eae6e7efecfbc9eee4e8e0e5a7eae6e4">[email&#160;protected]</a></h6>
</div>
...
<p><i class="zmdi zmdi-email"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b7d4d8d9d1d2c5f7d0dad6dedb99d4d8da">[email&#160;protected]</a></p>
